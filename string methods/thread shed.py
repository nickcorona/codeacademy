...
for transaction in daily_transactions:
    ...
    daily_transaction_split.append(data)
...
for thread in thread_sold:
    if '&' not in thread:
        ...
        two_threads = thread.split('&')
        thread_sold_split.append(two_threads[0])
        thread_sold_split.append(two_threads[1])
...
for color in colors:
    print('{count} threads of {color} sold.'.\
